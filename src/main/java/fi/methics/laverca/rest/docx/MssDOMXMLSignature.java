...
public class MssDOMXMLSignature extends DOMStructure
implements XMLSignature {
     ...
     */
    public MssDOMXMLSignature(SignedInfo si, KeyInfo ki,
     ...
     */
    public MssDOMXMLSignature(Element sigElem, XMLCryptoContext context,Provider provider)
            ...
            throws MarshalException, XMLSignatureException
    {
        ...
        for (Reference ref : allReferences) {
            try {
                Method isDigested = DOMReference.class.getDeclaredMethod("isDigested");
                isDigested.setAccessible(true);
                if ((Boolean)isDigested.invoke(ref, null)) {
                    continue;
                }
            } catch (Exception e) {
                e.printStackTrace();
...
//        }
    ...
    implements SignatureValue
    {
                ...
                throws XMLSignatureException
        {
            ...
            System.out.println("canonicalize SignedInfo and verify signature");
//            try {
